...
###########################################################################################
###########################################################################################
#0. set working directory and language settings
#working directory
...
png("plot4.png")
par(mfrow=c(2,2),mar=c(4,4,2,1)) # fill row-wise
#topleft
plot(dat$"Date",
...
with(dat,lines(dat$"Sub_metering_1" ~ dat$"Date",col="black"))
with(dat,lines(dat$"Sub_metering_2" ~ dat$"Date",col="red"))
with(dat,lines(dat$"Sub_metering_3" ~ dat$"Date",col="blue"))
legend("topright",
       lty=c(1,1),
